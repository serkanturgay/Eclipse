...
public class Test {
	...
	public static void main(String[] args) {
		...
		classroom1.department = department1;
		classroom1.block = "B block";
		classroom1.floor = 3;
		classroom1.courses = new Course[7];
		classroom1.courses[0] = course1;

		System.out.println(student1.coursesTaken[0].department.head.name);
		System.out.println(course1.clasroom.floor + " " + course1.clasroom.block);
